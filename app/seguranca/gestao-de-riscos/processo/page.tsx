          ...
          <div className="body wide-body">
            ...
            <div className="flow-diagram-wrap">
              ...
              >
                ...
                <text x="660" y="20" textAnchor="middle" fontSize="16" fontWeight="700" fill="var(--text)">
                  Processo de Gestão de Riscos
                </text>

                {/* Setas principais */}
                <path d="M 165 95 L 205 95" stroke="var(--text-muted)" strokeWidth="1.5" markerEnd="url(#flow-arrow)" />
                <path d="M 355 95 L 395 95" stroke="var(--text-muted)" strokeWidth="1.5" markerEnd="url(#flow-arrow)" />
                <path d="M 545 95 L 575 95" stroke="var(--text-muted)" strokeWidth="1.5" markerEnd="url(#flow-arrow)" />
                <path d="M 745 95 L 775 95" stroke="var(--text-muted)" strokeWidth="1.5" markerEnd="url(#flow-arrow)" />
                <text x="760" y="85" textAnchor="middle" fontSize="12" fill="var(--accent)" fontWeight="600">Sim</text>
                <path d="M 925 95 L 965 95" stroke="var(--text-muted)" strokeWidth="1.5" markerEnd="url(#flow-arrow)" />
                <path d="M 1115 95 L 1155 95" stroke="var(--text-muted)" strokeWidth="1.5" markerEnd="url(#flow-arrow)" />

                {/* Ramo "Não" */}
                <path d="M 660 150 L 660 190 L 850 190 L 850 226" stroke="var(--text-muted)" strokeWidth="1.5" fill="none" markerEnd="url(#flow-arrow)" />
                <text x="672" y="172" fontSize="12" fill="var(--accent)" fontWeight="600">Não</text>
                <path d="M 925 275 L 1230 275 L 1230 146" stroke="var(--text-muted)" strokeWidth="1.5" fill="none" markerEnd="url(#flow-arrow)" />

                {/* Caixa 1 - Identificação */}
                <rect x="15" y="50" width="150" height="90" rx="3" fill="var(--surface)" stroke="var(--border)" />
                <text x="90" y="72" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">Identificação</text>
                ...
                <text x="280" y="72" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">Cadastro</text>
                ...
                <text x="470" y="72" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">Análise e Classificação</text>
                <text x="470" y="94" textAnchor="middle" fontSize="10.5" fill="var(--text-muted)">
                ...
                <text x="660" y="88" textAnchor="middle" fontSize="11.5" fontWeight="700" fill="var(--text)">Exige</text>
                <text x="660" y="101" textAnchor="middle" fontSize="11.5" fontWeight="700" fill="var(--text)">Tratamento?</text>

                {/* Caixa 5 - Definição do Plano de Ação */}
                <rect x="775" y="50" width="150" height="90" rx="3" fill="var(--surface)" stroke="var(--border)" />
                <text x="850" y="68" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">
                  <tspan x="850" dy="0">Definição do Plano</tspan>
                  <tspan x="850" dy="14">de Ação</tspan>
                </text>
                <text x="850" y="103" textAnchor="middle" fontSize="10.5" fill="var(--text-muted)">
                  <tspan x="850" dy="0">Definição de objetivo,</tspan>
                  <tspan x="850" dy="14">responsável e prazo.</tspan>
                </text>

                {/* Caixa 6 - Acompanhamento */}
                <rect x="965" y="50" width="150" height="90" rx="3" fill="var(--surface)" stroke="var(--border)" />
                <text x="1040" y="72" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">Acompanhamento</text>
                <text x="1040" y="94" textAnchor="middle" fontSize="10.5" fill="var(--text-muted)">
                  <tspan x="1040" dy="0">Monitoramento periódico</tspan>
                  <tspan x="1040" dy="14">e revisão pelo Comitê.</tspan>
                </text>

                {/* Caixa 7 - Encerramento */}
                <rect x="1155" y="50" width="150" height="90" rx="3" fill="var(--surface)" stroke="var(--border)" />
                <text x="1230" y="72" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">Encerramento</text>
                <text x="1230" y="94" textAnchor="middle" fontSize="10.5" fill="var(--text-muted)">
                ...
                <rect x="775" y="230" width="150" height="90" rx="3" fill="var(--surface)" stroke="var(--border)" />
                <text x="850" y="248" textAnchor="middle" fontSize="12" fontWeight="700" fill="var(--text)">
                  <tspan x="850" dy="0">Emissão de Carta</tspan>
                  <tspan x="850" dy="14">de Risco</tspan>
                </text>
                <text x="850" y="284" textAnchor="middle" fontSize="10.5" fill="var(--text-muted)">
